            ...
            for i, j in zip(i_list, j_list):
                ...
                for dataname, axes in data3d_dict.items():
                    ...
                    if mask[i,j]:
                        ...
                        fit3d_result = fit3d.do_iterative_two_gauss3d_fit(data=data,xx=axes['xx'],yy=axes['yy'],zz=axes['zz'],force_positive=True,diff_threshold=0.002, max_iteration=4, verbose=verbose)
                    else:
                ...
                for dataname, axes in data2d_dict.items():
                    ...
                    if mask[i,j]:
                        ...
                        fit2d_result = fit2d.do_iterative_two_gauss2d_fit(data=data,xx=axes['xx'],yy=axes['yy'],force_positive=True,diff_threshold=0.002, max_iteration=4, verbose=verbose)
                    else:
