...
def main():
    ...
    ### data
    stepg200 = np.asarray(h5f200['/detectorsum/Ga-K_norm_stan/xanes_step'])[::-1,::-1]
    edgeg200 = np.asarray(h5f200['/detectorsum/Ga-K_norm_stan/xanes_edge'])[::-1,::-1]
    edgegdiff200 = edgeg200 - 10.367
    ga200    = np.asarray(h5f200['/detectorsum/Ga-K_norm/data'])[::-1,::-1,:]
    ...
    stepx200 = np.asarray(h5f200['/counters/zap_p201_Xbic_norm_stan/xanes_step'])[::-1,::-1]
    edgex200 = np.asarray(h5f200['/counters/zap_p201_Xbic_norm_stan/xanes_edge'])[::-1,::-1]
    ...
    ### data
    stepg400 = np.asarray(h5f400['/detectorsum/Ga-K_norm_stan/xanes_step'])[::-1,::-1]
    edgeg400 = np.asarray(h5f400['/detectorsum/Ga-K_norm_stan/xanes_edge'])[::-1,::-1]
    edgegdiff400 = edgeg400 - 10.367
    ga400    = np.asarray(h5f400['/detectorsum/Ga-K_norm/data'])[::-1,::-1,:]
    ni400    = np.asarray(h5f400['/detectorsum/Ni-K/data'])[::-1,::-1,:]
    ...
    xbic2015 = np.asarray(h5f2015['counters/zap_p201_IC/data'])
    ga2015 = np.asarray(h5f2015['detectorsum/Ga-K/data'])
    ni2015 = np.asarray(h5f2015['detectorsum/Ni-K/data'])
    as2015 = np.asarray(h5f2015['detectorsum/As-K/data'])
    ...
    #### select what to plot
    cropslice = ([0,800],[0,800])
    shift2015 = [0,0]
    shift2015 = ([shift2015[0]+cropslice[0][0],
                  shift2015[0]+cropslice[0][1]],
                 [shift2015[1]+cropslice[1][0],
                  shift2015[1]+cropslice[1][1]])
    
    image1 = data1[cropslice[0][0]:cropslice[0][1],cropslice[1][0]:cropslice[1][1]]
    image2 = data2[cropslice[0][0]:cropslice[0][1],cropslice[1][0]:cropslice[1][1]]
    image3 = data3[cropslice[0][0]:cropslice[0][1],cropslice[1][0]:cropslice[1][1]]
    
    image4 = data4[shift2015[0][0]:shift2015[0][1],shift2015[1][0]:shift2015[1][1]]
    image5 = data5[shift2015[0][0]:shift2015[0][1],shift2015[1][0]:shift2015[1][1]]
    image6 = data6[shift2015[0][0]:shift2015[0][1],shift2015[1][0]:shift2015[1][1]]
