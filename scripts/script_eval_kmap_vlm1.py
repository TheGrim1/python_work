...
def eval_vlm1_scan(args):
    ...
    with h5py.File(save_fname,'w') as h5_f:
        ...
        time_ds=position_group.create_dataset('time_of_frame',shape=mapshape,dtype=np.float32)
        ...
        for i,index in enumerate(index_list):
            ...
            if is_kmap:
                ...
                time_of_frame = kmap_edf['scan_0/instrument/detector_0/others/time_of_frame'][i]
            else:
                fname = edf_fname_list[i]
                edf = sio.open(fname)
                frame = edf['scan_0/instrument/detector_0/data']
                time_of_frame = edf['scan_0/instrument/detector_0/others/time_of_frame'][0]
